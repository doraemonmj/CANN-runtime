...
Full working example: :file:`examples/20-sync-queue/`

Host code demonstrating queue-based data passing:

.. literalinclude:: ../../examples/20-sync-queue/main.cpp
   :language: cpp
   :caption: 20-sync-queue/main.cpp
   :lines: 1-80

AICPU producer kernel:

.. literalinclude:: ../../examples/20-sync-queue/aicpu_kernel/producer.cpp
   :language: cpp
   :caption: 20-sync-queue/aicpu_kernel/producer.cpp

AICORE consumer kernel (PTO-ISA):

.. literalinclude:: ../../examples/20-sync-queue/aicore_kernel.pto
   :language: text
   :caption: 20-sync-queue/aicore_kernel.pto
